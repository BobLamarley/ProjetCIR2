...
<div class="row">
	<div class="col-sm-4">
		<a href="../vue/annoncetheme.php" class="btn btn-lg btn-primary" >Jeu Solo</a>
	</div>
	<div class="col-sm-4">
		<a href="../vue/menuprincipal.php" class="btn btn-lg btn-primary" >Jeu Multijoueur</a>
	</div>
	<div class="col-sm-4">
		<a href="../vue/palmares.php" class="btn btn-lg btn-primary" >Palmarès</a>
	</div>
